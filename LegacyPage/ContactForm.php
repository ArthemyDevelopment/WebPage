...
if (isset($_POST['Email'])) {
    ...
    $email_to = "arthemydevelopment@gmail.com";
    $email_subject = "New form submission from web site";
    ...
    $subject = $__POST['Subject']//required
    ...
    if(!preg_match($string_exp, $subject)){
        $error_message .= 'The Subjetc you entered does not appear to be valid.<br>';
    }
